...
namespace Starwars
{
    class Program
    {
        ...
        {
            //all the code you want to look at, is in the class PlanetExtraction
            
            List<Planet> planets = LoadData();

            List<IEnumerable<Planet>> taskResults = new List<IEnumerable<Planet>>();

            taskResults.Add(PlanetExtraction.TaskOne(planets));
            taskResults.Add(PlanetExtraction.TaskTwo(planets));
            taskResults.Add(PlanetExtraction.TaskThree(planets));
            taskResults.Add(PlanetExtraction.TaskFour(planets));
            taskResults.Add(PlanetExtraction.TaskFive(planets));
            taskResults.Add(PlanetExtraction.TaskSix(planets));
            taskResults.Add(PlanetExtraction.TaskSeven(planets));
            taskResults.Add(PlanetExtraction.TaskEight(planets));
            taskResults.Add(PlanetExtraction.TaskNine(planets));
            taskResults.Add(PlanetExtraction.TaskTen(planets));
            taskResults.Add(PlanetExtraction.TaskEleven(planets));
            taskResults.Add(PlanetExtraction.TaskTwelve(planets));
            taskResults.Add(PlanetExtraction.TaskThirteen(planets));
            taskResults.Add(PlanetExtraction.TaskFourteen(planets));
            taskResults.Add(PlanetExtraction.TaskFifteen(planets));
            taskResults.Add(PlanetExtraction.TaskSixteen(planets));

            int counter = 1;
            foreach (IEnumerable<Planet> result in taskResults)
            {
